...
if menu == "🏠 Home":
    ...
    st.image(
        "https://baskinnature.in/wp-content/uploads/2024/08/close-up-mango-fruit-mango-tree-scaled-1.webp",use_container_width=True
    )
    ...
    **Symptoms**
    ...
    - Premature leaf fall under severe infection

    **Favourable Conditions**
    - High humidity
    - Frequent rainfall
    - Poor orchard ventilation
    """)
    ...
    **Symptoms**
    ...
    - Gum exudation on affected parts
    ...
    **Symptoms**
    - Black soot-like fungal growth on leaves
    - Reduced photosynthesis
    - Poor fruit appearance and quality

    **Favourable Conditions**
    - High humidity
    - Presence of honeydew-secreting insects
